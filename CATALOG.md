...
Auto-generated index of every AG-UI project this repo can resolve and check. The curated, organized list
is [README.md](README.md).

| Name | What it does | ★ | AG-UI dependency |
|---|---|---|---|
| [langchain](https://github.com/langchain-ai/langchain) | Serve a LangChain agent over AG-UI | 145.1k | ✅ the protocol repo ships an integration for it |
| [crewAI](https://github.com/crewAIInc/crewAI) | Drive a CrewAI Flow from the browser | 57.7k | ✅ the protocol repo ships an integration for it |
| [llama_index](https://github.com/run-llama/llama_index) | Give a LlamaIndex agent a front end | 51.9k | ✅ the protocol repo ships an integration for it |
| [agno](https://github.com/agno-agi/agno) | Put an Agno agent behind a copilot | 41.9k | ✅ the protocol repo ships an integration for it |
| [langgraph](https://github.com/langchain-ai/langgraph) | Stream a LangGraph run into a React app | 40.5k | ✅ the protocol repo ships an integration for it |
| [CopilotKit](https://github.com/CopilotKit/CopilotKit) | Drop a copilot into a React, Angular, or mobile app | 37.1k | ✅ package.json declares an AG-UI package |
| [mastra](https://github.com/mastra-ai/mastra) | Wire a Mastra agent to a chat UI | 27.5k | ✅ the protocol repo ships an integration for it |
| [ai](https://github.com/vercel/ai) | Bridge the Vercel AI SDK | 26.4k | ✅ the protocol repo ships an integration for it |
| [adk-python](https://github.com/google/adk-python) | Bring a Google ADK agent into a front end | 21.3k | ✅ the protocol repo ships an integration for it |
| [pydantic-ai](https://github.com/pydantic/pydantic-ai) | Serve a Pydantic AI agent over AG-UI | 19.5k | ✅ the protocol repo ships an integration for it |
| [ag-ui](https://github.com/ag-ui-protocol/ag-ui) | Read the protocol itself | 15.6k | ✅ package.json declares an AG-UI package |
| [agent-framework](https://github.com/microsoft/agent-framework) | Attach a UI to Microsoft Agent Framework | 13.1k | ✅ the protocol repo ships an integration for it |
...
| [harness-sdk](https://github.com/strands-agents/harness-sdk) | Run AWS Strands agents with a UI attached | 7k | ✅ the protocol repo ships an integration for it |
...
| [ALwrity](https://github.com/ALwrity/ALwrity) | ALwrity - AI-first Digital Marketing Platform. AI Content Strategy and Planning, Multimodal content generation,… | 1.1k | ✅ frontend/package.json declares a CopilotKit package |
...
| [aimock](https://github.com/CopilotKit/aimock) | Mock everything the app talks to | 902 | ✅ package.json declares a CopilotKit package |
| [channels-sdk](https://github.com/CopilotKit/channels-sdk) | Put your agent in Slack, Teams, or Discord | 873 | ✅ examples/mastra-sandbox/package.json declares an AG-UI package |
| [financial-agent-ui](https://github.com/virattt/financial-agent-ui) | Study a finished generative-UI front end | 794 | — |
| [bedrock-agentcore-sdk-python](https://github.com/aws/bedrock-agentcore-sdk-python) | Ship an agent on Bedrock AgentCore | 755 | ✅ pyproject.toml declares an AG-UI package |
| [datafoundry](https://github.com/datagallery-ai/datafoundry) | Analyse data in an agent workbench | 740 | ✅ package.json declares an AG-UI package |
...
| [shadify](https://github.com/CopilotKit/shadify) | Stream shadcn components instead of plain text | 263 | ✅ apps/agent/pyproject.toml declares a CopilotKit package |
| [AgenticX](https://github.com/DemonDamon/AgenticX) | Build on a production multi-agent platform | 218 | — |
...
| [agentpool](https://github.com/phil65/agentpool) | Orchestrate a pool of configured agents | 183 | ✅ pyproject.toml declares an AG-UI package |
...
| [ibm-watsonx-orchestrate-adk](https://github.com/IBM/ibm-watsonx-orchestrate-adk) | Reach IBM watsonx Orchestrate from a front end | 176 | ✅ the protocol repo ships an integration for it |
...
| [agent-kernel](https://github.com/yaalalabs/agent-kernel) | The Operating System for Scalable Enterprise AI Agents - Run, orchestrate, and deploy Compliant Enterprise AI Agents… | 135 | ✅ ak-py/pyproject.toml declares an AG-UI package |
...
| [agent-sphere](https://github.com/nullpointexception-i/agent-sphere) | This project is an AI Agent orchestration platform. It uses an LLM-driven decision engine, combined with capabilities… | 121 | ✅ agent-sphere-copilot-widget/package.json declares an AG-UI package |
| [copilotkit-mcp-demo](https://github.com/CopilotKit/copilotkit-mcp-demo) |  | 114 | ✅ package.json declares a CopilotKit package |
| [coding-agent](https://github.com/AbhinavTheDev/coding-agent) | Your own Coding Agent 🤖 | 107 | ✅ agent/pyproject.toml declares a CopilotKit package |
| [v0-copilot-next](https://github.com/Tabintel/v0-copilot-next) |  | 98 | ✅ package.json declares a CopilotKit package |
| [second-brain-research-dashboard](https://github.com/coleam00/second-brain-research-dashboard) |  | 95 | ✅ agent/pyproject.toml declares an AG-UI package |
...
| [vue-copilotkit](https://github.com/fe-51shebao/vue-copilotkit) | Reach for a Vue component library | 87 | ✅ package.json declares a CopilotKit package |
| [angular-agent-framework](https://github.com/cacheplane/angular-agent-framework) | Build agentic Angular apps | 70 | ✅ package.json declares an AG-UI package |
...
| [ATHENA](https://github.com/mims-harvard/ATHENA) | Reason over a biomedical knowledge graph | 63 | ✅ pyproject.toml declares an AG-UI package |
...
| [agent-sdk-go](https://github.com/agenticenv/agent-sdk-go) | Durable execution framework for AI agents in Go. Keeps agent state, tool calls, and execution loops resilient across… | 51 | ✅ examples/agent_with_agui/ui/package.json declares an AG-UI package |
| [TitanX](https://github.com/CES-Ltd/TitanX) | Enterprise AI Agent Orchestration Platform — Secure, Observable, Configurable. Multi-agent teams with IAM policies,… | 46 | ✅ package.json declares a CopilotKit package |
...
| [inalpha](https://github.com/mirror29/inalpha) | 🦊 Open-source professional quant agent framework. Agents pick the factors working now to time entries, write full… | 32 | ✅ apps/dashboard/package.json declares an AG-UI package |
...
| [sample-FAST-applications](https://github.com/aws-samples/sample-FAST-applications) | Fullstack AgentCore Solution Template samples repository. See what others have built with FAST! | 29 | ✅ samples/copilotkit-generative-ui/pyproject.toml declares a CopilotKit package |
| [langgraph-interrupt-workflow-template](https://github.com/KirtiJha/langgraph-interrupt-workflow-template) | ⚡ Production-ready LangGraph interrupt template with modern web interface \| Human-in-the-loop AI workflows \| FastAPI… | 29 | ✅ examples/copilotkit/package.json declares an AG-UI package |
...
| [a2a-demo](https://github.com/ag-ui-protocol/a2a-demo) | See A2A and AG-UI in one app | 26 | ✅ package.json declares an AG-UI package |
...
| [Perth-Agent-Con-Workshop](https://github.com/0XFF-96/Perth-Agent-Con-Workshop) |  | 23 | ✅ package.json declares a CopilotKit package |
...
| [opensearch-agent-server](https://github.com/opensearch-project/opensearch-agent-server) | Query OpenSearch through an agent | 18 | ✅ pyproject.toml declares an AG-UI package |
...
| [glassbox](https://github.com/jonathanhawkins/glassbox) | Glassbox: a glass cockpit over a self-improving agent swarm that writes real, graded code. WeaveHacks 4. | 14 | ✅ apps/web/package.json declares a CopilotKit package |
| [Agents.KT](https://github.com/Deep-CodeAI/Agents.KT) | Define agents in a typed Kotlin DSL | 13 | — |
...
| [agent-sdk-go](https://github.com/hastekit/agent-sdk-go) | Build AG-UI agents in Go | 12 | ✅ pkg/agui/web/ui/package.json declares an AG-UI package |
| [GenUI-LoomAgent](https://github.com/qingkongzhiqian/GenUI-LoomAgent) | 🧶 Open-source GenUI Agent framework — AI autonomously decides which UI components to render. Powered by LangGraph +… | 12 | ✅ backend/requirements.txt declares an AG-UI package |
| [ag-ui-adk-react-chat](https://github.com/rrazvd/ag-ui-adk-react-chat) | Poke at an ADK playground | 12 | ✅ package.json declares an AG-UI package |
| [agent-craft-lab](https://github.com/TimothySu2015/agent-craft-lab) | Open-source AI Agent platform built on .NET — design, test, and deploy agent workflows | 12 | ✅ AgentCraftLab.Web/package.json declares an AG-UI package |
...
| [UIX](https://github.com/Deepractice/UIX) | AI-to-UI IR Protocol Layer — The Last Mile from AI to Human. Includes Lucid UI Skill for professional AI-generated… | 10 | ✅ packages/adapter-agui/package.json declares an AG-UI package |
| [si-mapper](https://github.com/hq-opensource/si-mapper) | Transform static HVAC multi-modal data into an engineering-equivalent digital twin. The agent will autonomously… | 10 | ✅ mapper/package.json declares an AG-UI package |
| [deepclaw](https://github.com/shell-nlp/deepclaw) | deepclaw，一个开源的 agent/rag 脚手架 | 10 | ✅ pyproject.toml declares an AG-UI package |
...
| [haiku.skills](https://github.com/ggozad/haiku.skills) | Give an agent Agent Skills | 9 | ✅ pyproject.toml declares an AG-UI package |
| [json-to-ui](https://github.com/lijie1024512/json-to-ui) | 生成式UI:formily.js+shadcn生成json | 9 | ✅ package.json declares a CopilotKit package |
...
| [archi](https://github.com/sv-priv/archi) | Your system design companion | 7 | ✅ backend/requirements.txt declares a CopilotKit package |
...
| [presentation_ai_copilot](https://github.com/AyushDhamecha/presentation_ai_copilot) |  | 6 | ✅ package.json declares a CopilotKit package |
...
| [cli](https://github.com/inference-gateway/cli) | A Git-first CLI coding agent that turns ideas, issues, and tasks into real code changes. It can run remotely from your… | 5 | ✅ go.mod declares an AG-UI package |
...
| [Research_as_a_Code](https://github.com/Research-as-a-Code/Research_as_a_Code) | UDF + AI-Q + TTD DR + IaaC (AWS EKS and NIMs) + AG-UI + CopilotKit | 5 | ✅ backend/requirements.txt declares a CopilotKit package |
| [Research-Agent](https://github.com/senisinsane/Research-Agent) | 🔍 Production-ready autonomous web research agent built with LangChain & OpenAI. Accepts queries via CLI or API,… | 5 | ✅ requirements.txt declares an AG-UI package |
...
| [sample-agentcore-enterprise-platform](https://github.com/aws-samples/sample-agentcore-enterprise-platform) | Amazon Bedrock AgentCore enterprise platform accelerator with AWS CDK, Terraform organization guardrails, MCP/A2A… | 4 | ✅ agent-code/agui-langgraph-agent/requirements.txt declares a CopilotKit package |
...
| [find-the-bug](https://github.com/CopilotKit/find-the-bug) | Practise on a broken app on purpose | 3 | ✅ my-app/package.json declares a CopilotKit package |
| [based](https://github.com/Cyronius/based) | A native database workbench for SQL Server, Snowflake, and LanceDB, built around AI that can actually see and work… | 3 | ✅ core/package.json declares an AG-UI package |
| [rag](https://github.com/DimaOshchepkov/rag) | RAG with hybrid search (BGE-M3 + Qdrant RRF), LangGraph agent via AG-UI protocol, CopilotKit chat frontend. 7… | 3 | ✅ services/agent/pyproject.toml declares a CopilotKit package |
| [agentic-fullstack-template](https://github.com/fulltechfactory/agentic-fullstack-template) | A fullstack template for building AI agentic applications with CopilotKit and Agno | 3 | ✅ backend/requirements.txt declares an AG-UI package |
| [agentickit](https://github.com/hec-ovi/agentickit) | AI copilot for React apps. Reads your state, fills forms, confirms actions, calls your tools. Multi-agent, AI SDK 6 +… | 3 | ✅ examples/travel/package.json declares an AG-UI package |
| [foundry-voice-live](https://github.com/iLoveAgents/foundry-voice-live) | SDK and tools for Microsoft Foundry Voice Live API - real-time voice interactions with AI agents | 3 | ✅ examples/package.json declares an AG-UI package |
| [virtual-panel-action-plan-scoring](https://github.com/JamiesonLabUTSW/virtual-panel-action-plan-scoring) | Demonstrates how example-conditioned LLM personas can simulate expert rater panels and generate consensus evaluations,… | 3 | ✅ client/package.json declares a CopilotKit package |
| [hybrid-multi-agents](https://github.com/jetzlstorfer/hybrid-multi-agents) |  | 3 | ✅ web/package.json declares an AG-UI package |
| [PAI-DeepSearch](https://github.com/KilluaYZ/PAI-DeepSearch) | 用PAI-Langstudio实现Research Agent | 3 | ✅ pyproject.toml declares an AG-UI package |
| [langchain-copilotkit](https://github.com/mahm/langchain-copilotkit) | CopilotKit Integration for LangChain Agent (deepagentsjs) | 3 | ✅ sample/package.json declares a CopilotKit package |
| [grad-paddy](https://github.com/olamideba/grad-paddy) | Grad Paddy is a multi-step AI agent built for the Google Cloud Rapid Agent Hackathon. It targets the graduate school… | 3 | ✅ frontend/package.json declares an AG-UI package |
| [agui-deepchat-integration](https://github.com/oroszgy/agui-deepchat-integration) | AG-UI DeepChat integration PoC | 3 | ✅ ui/package.json declares an AG-UI package |
| [music-attribution-scaffold](https://github.com/petteriTeikari/music-attribution-scaffold) | Research scaffold for multi-source music attribution with transparent confidence scoring. Companion code to Teikari,… | 3 | ✅ frontend/package.json declares a CopilotKit package |
| [Dominad](https://github.com/samy-clivolt/Dominad) | Watch competitive intelligence assemble itself | 3 | ✅ package.json declares an AG-UI package |
| [ag-ui-langgraph-agent](https://github.com/TheGreatBonnie/ag-ui-langgraph-agent) |  | 3 | ✅ pyproject.toml declares an AG-UI package |
| [agentkit](https://github.com/trumhemcut/agentkit) | Build agentic ai application with ease | 3 | ✅ backend/requirements.txt declares an AG-UI package |
| [agui-pda-antdv-demo](https://github.com/yuWorm/agui-pda-antdv-demo) |  | 3 | ✅ frontend/package.json declares an AG-UI package |
| [ai-trader-view](https://github.com/adi199/ai-trader-view) |  | 2 | ✅ package.json declares a CopilotKit package |
| [CopilotKitAgentFramework](https://github.com/adner/CopilotKitAgentFramework) |  | 2 | ✅ copilotkitagentframework/package.json declares an AG-UI package |
| [ag-ui-devtools](https://github.com/albsugy/ag-ui-devtools) | Developer tools for the AG-UI protocol. Inspect, debug, and replay AI agent sessions with a local web UI | 2 | ✅ apps/devtools/package.json declares an AG-UI package |
...
| [django-copilotkit](https://github.com/sasaeo/django-copilotkit) | This repository provides an example of how to integrate CopilotKit with a Django backend. Since the official… | 2 | ✅ requirements.txt declares a CopilotKit package |
...
| [agent-sdk](https://github.com/agenetix/agent-sdk) | Embeddable AI chat widget powered by MCP. Published as @agenetix/agent-sdk. | 1 | ✅ package.json declares an AG-UI package |
...
| [v0.2_MULTI-AGENT_frontend](https://github.com/alchimie-di-circe/v0.2_MULTI-AGENT_frontend) | Next + CopilotKit & AG-UI + (MCP UI + C1 integration) | 1 | ✅ package.json declares an AG-UI package |
...
| [generative-a11y](https://github.com/bhaveshchow20/generative-a11y) | Keep a streaming agent interface accessible | 1 | ✅ package.json declares an AG-UI package |
...
| [effect-agent](https://github.com/doeixd/effect-agent) | An Effect-native agent execution kernel: sessions, runs, turns, steering, follow-ups and typed lifecycle events on top… | 1 | ✅ package.json declares an AG-UI package |
...
| [af-agno-agui-cookbook](https://github.com/fancn21th/af-agno-agui-cookbook) | Agno Ag-UI Cookbook | 1 | ✅ package.json declares an AG-UI package |
| [foot-agui-sample](https://github.com/fredgis/foot-agui-sample) | AG-UI plus GPT5.2 avec Microsoft Agent Framework | 1 | ✅ package.json declares an AG-UI package |
| [hanfani-core](https://github.com/fruitizz/hanfani-core) | Headless TypeScript core for human-in-the-loop agent workflows. | 1 | ✅ package.json declares an AG-UI package |
| [recipe-ai-assistant](https://github.com/gsumithub/recipe-ai-assistant) |  | 1 | ✅ package.json declares a CopilotKit package |
| [SETv2](https://github.com/GucciGross/SETv2) |  | 1 | ✅ channels/package.json declares an AG-UI package |
| [ag-ui-server-bedrock](https://github.com/Hailong-am/ag-ui-server-bedrock) |  | 1 | ✅ pyproject.toml declares an AG-UI package |
...
| [document-to-diagram](https://github.com/jerelvelarde/document-to-diagram) |  | 1 | ✅ package.json declares an AG-UI package |
...
| [opensearch-agent-server](https://github.com/mingshl/opensearch-agent-server) |  | 1 | ✅ pyproject.toml declares an AG-UI package |
...
| [MicrosoftAgentFrameworkAgentWithVueAG-UIClient](https://github.com/pjrusso/MicrosoftAgentFrameworkAgentWithVueAG-UIClient) |  | 1 | ✅ VueAG-UIClient/package.json declares an AG-UI package |
...
| [a4i](https://github.com/rakesh-vs/a4i) |  | 1 | ✅ ui/package.json declares an AG-UI package |
| [polyglot-devenv](https://github.com/ricable/polyglot-devenv) | Polyglot development environment with Python, TypeScript, Rust, Go, and Nushell using Devbox for isolated,… | 1 | ✅ dojo/package.json declares an AG-UI package |
| [CopilotKit_Generative_UI_MCP_Framework](https://github.com/Roentek/CopilotKit_Generative_UI_MCP_Framework) | A plug-and-play framework for building AI-powered generative user interfaces using CopilotKit, MCP Apps and… | 1 | ✅ package.json declares an AG-UI package |
| [dotnet-ng-chat](https://github.com/rstropek/dotnet-ng-chat) |  | 1 | ✅ ChatClient/package.json declares an AG-UI package |
...
| [nexus](https://github.com/travisnielsen/nexus) | Nexus is a reference design for an interactive dashboard powered by AG-UI and Microsoft Agent Framework. | 1 | ✅ src/frontend/package.json declares an AG-UI package |
...
| [registry](https://github.com/zonlabs/registry) | Register and discover agents | 1 | ✅ requirements.txt declares an AG-UI package |
| [memory-companion-genui](https://github.com/alinjfz/memory-companion-genui) | Adaptive generative-UI care companion for calm, familiar day-to-day support. | 0 | ✅ package.json declares an AG-UI package |
| [Agentic-Dynamic-UI-CRM-example-](https://github.com/arjunagi-a-rehman/Agentic-Dynamic-UI-CRM-example-) | Agentic Dynamic UI — an AI agent that answers with live, interactive React components (forms, tables, charts, confirm… | 0 | ✅ agent/requirements.txt declares an AG-UI package |
| [copilotkit-consulting-dashboard](https://github.com/Beg1nner4ever/copilotkit-consulting-dashboard) | AI-powered consulting engagement dashboard built with CopilotKit and AG-UI protocol | 0 | ✅ package.json declares a CopilotKit package |
| [ag_ui_debug](https://github.com/dddd1127/ag_ui_debug) |  | 0 | ✅ server/requirements.txt declares an AG-UI package |
| [teaching-assistant](https://github.com/dsouzavijeth/teaching-assistant) | An AI tutor that generates interactive lessons — a live math playground, comparisons, quizzes, real images — one step… | 0 | ✅ package.json declares an AG-UI package |
| [kenya-agui](https://github.com/gabrielmahia/kenya-agui) | First East African AG-UI implementation — connects civic AI agents to live frontends via the Agent-User Interaction… | 0 | ✅ pyproject.toml declares an AG-UI package |
...
| [free-grokbot](https://github.com/jayamitkatariya/free-grokbot) | Autobot — self-hosted AI coworkers with BYOK, browser + files + MCP, local Postgres threads. Fork of OpenBot, no… | 0 | ✅ package.json declares a CopilotKit package |
| [agui-crewai-demo](https://github.com/jerelvelarde/agui-crewai-demo) | Cadence — a CopilotKit x CrewAI competitive-intelligence demo on ag-ui-crewai 0.3.0 | 0 | ✅ web/package.json declares an AG-UI package |
| [solarsimpilot](https://github.com/sharabhshukla/solarsimpilot) | Solar + battery sizing app where an AI copilot and the dashboard share live state (FastAPI · Microsoft Agent Framework… | 0 | ✅ frontend/package.json declares an AG-UI package |
| [ai-agri-agent-nextjs](https://github.com/YashNarK/ai-agri-agent-nextjs) | An AI enabled agricultural data visualization dashboard with talk-to-your-data style chatbot powered by LangGraph | 0 | ✅ package.json declares an AG-UI package |

<sub>348 AG-UI projects · same rows as data in [catalog.csv](catalog.csv) · rebuilt by
